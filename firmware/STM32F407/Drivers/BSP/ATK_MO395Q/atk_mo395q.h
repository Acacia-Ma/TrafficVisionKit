...
typedef struct atk_mo395q_socket
{
    ...
    void (*open_cb)(struct atk_mo395q_socket *socket);          /* 开启回调 */
    void (*close_cb)(struct atk_mo395q_socket *socket);         /* 关闭回调 */
