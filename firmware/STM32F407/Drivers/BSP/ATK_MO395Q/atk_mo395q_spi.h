...
/* SPI接口定义 */
#define ATK_MO395Q_SPI_INTERFACE                SPI1
#define ATK_MO395Q_SPI_BAUDRATEPRESCALER        SPI_BAUDRATEPRESCALER_4
#define ATK_MO395Q_SPI_CLK_ENABLE()             do{ __HAL_RCC_SPI1_CLK_ENABLE(); }while(0)

/* 引脚定义 */
#define ATK_MO395Q_SPI_SCK_GPIO_PORT            GPIOB
#define ATK_MO395Q_SPI_SCK_GPIO_PIN             GPIO_PIN_3
#define ATK_MO395Q_SPI_SCK_GPIO_AF              GPIO_AF5_SPI1
...
#define ATK_MO395Q_SPI_MISO_GPIO_PIN            GPIO_PIN_4
#define ATK_MO395Q_SPI_MISO_GPIO_AF             GPIO_AF5_SPI1
...
#define ATK_MO395Q_SPI_MOSI_GPIO_PIN            GPIO_PIN_5
#define ATK_MO395Q_SPI_MOSI_GPIO_AF             GPIO_AF5_SPI1
